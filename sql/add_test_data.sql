...
INSERT INTO Gift (name, status, added, description, account_id, person_id)
    VALUES ('Maljakko', 0, NOW(), 'Iittalan uusi maljakko on valmistettu lasista.', 1, 1);
INSERT INTO Gift (name, status, added, description, account_id, person_id)
    VALUES ('Sukat', 0, NOW(), 'Hauskat raidalliset sukat.', 1, 2);
INSERT INTO Gift (name, status, added, description, account_id, person_id)
    VALUES ('Nintendo Switch', 1, NOW(), 'Nintendo Switch on Nintendon pelikonsoli, joka julkaistiin 3. maaliskuuta 2017. Pelikonsolia voi käyttää sekä kannettavana käsikonsolina että telakoituna kotikonsolina, joka kytketään televisioon. Laitteessa on kaksi irrotettavaa Joy-Con-ohjainta.', 1, 2);
